...
def main():
    ...
    parser.add_argument('--config',
                        default='configs/neus-sl-geoalbamb-capture-blur.yaml', required=False,
                        help='path to config file')

    parser.add_argument('--gpu',
                        default='0', help='GPU(s) to be used')
    parser.add_argument('--resume',
                        # default='[ckpt address to resume]',
                        default=None,
    ...
    parser.add_argument(
        ...
        help='specify this argument to restore only the weights (w/o training states), '
             'e.g. --resume path/to/resume --resume_weights_only'
    )


    group = parser.add_mutually_exclusive_group(required=False)
    group.add_argument('--train', default='True', action='store_true')
    group.add_argument('--validate', default='False', action='store_true')
    group.add_argument('--test', default='False', action='store_true')
